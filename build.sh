...
# define variables
PROJECT_ID=${PROJECT_ID:-novaland-337909}
...
sed -ri '' "s/backend-swap-api:.*$/backend-swap-api:${tag}/g" k8s/dev/api/backend-dp.yml
kubectl apply -f k8s/dev/api/backend-dp.yml
